...
//                 // snap to whole pixels → removes jitter
...
//                     <div className="relative h-[540px] lg:h-[680px] overflow-hidden rounded-[32px]">
//                         <div
...
//                                     >
//                                         {/* Quote icon */}
//                                         <span className="absolute top-6 right-6 text-neutral-300 text-[60px] text-orange-400 leading-none">
//                                             ❝
//                                         </span>
...
//                     {/* RIGHT — ARCHITECTURAL CONTEXT */}
//                     <div className="hidden lg:flex flex-col">
//                         <span className="text-sm font-semibold tracking-widest text-orange-500 mb-4">
//                             CLIENT EXPERIENCE
//                         </span>
...
//                                 <div
//                                     key={i}
//                                     className="relative rounded-2xl bg-white px-3 py-3
//                              border border-neutral-200
