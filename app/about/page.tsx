...
// export default function AboutExtendedAlt() {
...
//   return (
//     <div className="relative py-16 bg-neutral-50 lg:px-40 px-4 sm:px-6 md:px-10">
//       {/* Header */}
...
//                       overflow: "hidden",
//                     }}
//                     className="px-6 text-neutral-600 text-sm font-poppins "
//                   >
//                     {item.description}
//                   </div>
//                 </div>
...
//       {/* Our Goals Timeline */}
//       <div className="mt-20 max-w-6xl mx-auto relative px-4 sm:px-6 lg:px-0">
...
//   return (
//     <section className="relative py-16 bg-neutral-50 lg:px-40 px-4 sm:px-6 md:px-10 overflow-hidden">
//       {/* Staggered CEO Image Grid Background */}
//       <div
//         aria-hidden
//         className="absolute inset-0 z-0 pointer-events-none flex flex-wrap justify-center items-center gap-10 opacity-10"
//       >
...
//             style={{
//               transform: `rotate(${(-15 + i * 10) % 30}deg) translate(${i * 10}px, ${
//                 i * -5
//               }px)`,
//             }}
//           >
