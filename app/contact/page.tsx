...
//     e.preventDefault();
//     // TODO: send form to server or API
...
//   return (
//     <section className="relative w-full min-h-screen bg-gray-50/10 overflow-hidden">
...
//             <span
//               key={i}
//               className="text-6xl lg:text-8xl font-bold text-gray-300 rotate-[-15deg] m-4 select-none" font-zen-dots
//             >
//               Gozicornarc
//             </span>
//           ))}
...
//           alt="Watermark"
//           className="absolute top-20 left-10 w-1/4 opacity-5 rotate-[-10deg]"
//         />
//         <img
//           src="/img/gozie-consult.JPG"
//           alt="Watermark"
//           className="absolute bottom-10 right-0 w-1/4 opacity-5 rotate-[10deg]"
//         />
//       </div>
...
//           <h1 className="text-4xl lg:text-6xl font-extrabold font-michroma text-gray-900">
//             Get in Touch
//           </h1>
...
//             className="bg-white/90 backdrop-blur-md p-8 rounded-xl shadow-xl space-y-6"
//           >
//             {submitted && (
